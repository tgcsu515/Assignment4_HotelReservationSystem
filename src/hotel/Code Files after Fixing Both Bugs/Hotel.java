 ...
 *
 * In this program, I write the code to fix the second bug which was occuring in the record service process.
 */
...
public class Hotel {
	...
	public void checkout(int roomId) {
		...
		booking.checkOut();
                //Fixing the second bug by removing the roomId from the hashmap
