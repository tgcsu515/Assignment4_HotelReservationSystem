 ...
 *
 * In this program, I write the code to fix the first bug which was occuring in the checkout process.
 */
...
public class Booking {
	...
	public void checkIn() {
        ...
        //fixed the first reported bug by changing the variable name from "cosst" to "cost"
